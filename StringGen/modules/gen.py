...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@ArchBots"))
        else:
            ...
            await client.join_chat("ArchBots")
    except KeyError:
        pass
    try:
